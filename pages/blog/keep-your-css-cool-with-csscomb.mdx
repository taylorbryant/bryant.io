...
export const meta = {
  ...
  summary: `How to use CSScomb to keep your CSS clean and consistent.`,
  url: `/keep-your-css-cool-with-csscomb`
};
...
![How to Install CSScomb](/static/images/keep-your-css-cool-with-csscomb-install-csscomb.gif)
...
![How to Use CSScomb](/static/images/keep-your-css-cool-with-csscomb-use-csscomb.gif)
