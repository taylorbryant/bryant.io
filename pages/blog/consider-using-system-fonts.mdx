...
export const meta = {
  ...
  summary: `Next time you find yourself reaching for Google Fonts or Typekit, stop for a
  moment, and consider using system fonts.`,
  url: `/consider-using-system-fonts`
};
...
Here's an approach I borrowed from [Medium](https://medium.com). It provides support for versions of macOS, Windows, Android, and Ubuntu.
