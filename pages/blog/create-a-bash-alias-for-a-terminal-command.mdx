...
export const meta = {
  ...
  url: `/create-a-bash-alias-for-a-terminal-command`
};
...
![Step 1](/static/images/create-a-bash-alias-for-a-terminal-command/step-1.png)
...
![Step 2](/static/images/create-a-bash-alias-for-a-terminal-command/step-2.png)
...
![Step 3](/static/images/create-a-bash-alias-for-a-terminal-command/step-3.png)

Press **CTRL+X** to exit Nano and save your changes to **.bash_profile**. If everything looks right, press **Y**.

![Step 4](/static/images/create-a-bash-alias-for-a-terminal-command/step-4.png)
...
![Step 5](/static/images/create-a-bash-alias-for-a-terminal-command/step-5.png)
...
![Step 6](/static/images/create-a-bash-alias-for-a-terminal-command/step-6.png)
