import PostPageLayout from "../../components/post-page-layout-page-layout";

export const meta = {
  isPublished: true,
  date: `2017-10-09`,
  title: `An adventure in image zooming`,
  summary: `Learn how to use Zoom.js`,
...
![Zoom.js Example](/images/blog/an-adventure-in-image-zooming/example.gif)
