...
<iframe
  height="500"
  scrolling="no"
  src="//codepen.io/taylorbryant/embed/ppdOZN/?height=500&default-tab=html,result&embed-version=3&editable=true"
  frameBorder="no"
...
<iframe
  height="500"
  scrolling="no"
  src="//codepen.io/taylorbryant/embed/YYEeMW/?height=500&default-tab=html,result&embed-version=3&editable=true"
  frameBorder="no"
  allowtransparency="true"
  allowFullScreen={true}
  className="w-full mb-6 outline-none"
...
<iframe
  height="500"
  scrolling="no"
  src="//codepen.io/taylorbryant/embed/dJZqjg/?height=500&default-tab=html,result&embed-version=3&editable=true"
  frameBorder="no"
  allowtransparency="true"
  allowFullScreen={true}
  className="w-full mb-6 outline-none"
