...
export const meta = {
  ...
  url: `/solving-my-margin-headache`
};
...
<iframe
  height="500"
  scrolling="no"
  src="//codepen.io/taylorbryant/embed/ppdOZN/?height=500&default-tab=js,result&embed-version=3&editable=true"
  frameBorder="no"
...
<iframe
  height="500"
  scrolling="no"
  src="//codepen.io/taylorbryant/embed/YYEeMW/?height=500&default-tab=js,result&embed-version=3&editable=true"
  frameBorder="no"
  allowtransparency="true"
  allowFullScreen={true}
  className="mb-4 outline-none w-full"
...
<iframe
  height="500"
  scrolling="no"
  src="//codepen.io/taylorbryant/embed/dJZqjg/?height=500&default-tab=js,result&embed-version=3&editable=true"
  frameBorder="no"
  allowtransparency="true"
  allowFullScreen={true}
  className="mb-4 outline-none w-full"
