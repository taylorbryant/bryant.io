...
![Step 1](/static/blog/create-a-bash-alias-for-a-terminal-command/step-1.png)
...
![Step 2](/static/blog/create-a-bash-alias-for-a-terminal-command/step-2.png)
...
![Step 3](/static/blog/create-a-bash-alias-for-a-terminal-command/step-3.png)

Press **CTRL+X** to exit Nano and save your changes to **.bash_profile**. If everything looks right, press **Y**.

![Step 4](/static/blog/create-a-bash-alias-for-a-terminal-command/step-4.png)
...
![Step 5](/static/blog/create-a-bash-alias-for-a-terminal-command/step-5.png)
...
![Step 6](/static/blog/create-a-bash-alias-for-a-terminal-command/step-6.png)
